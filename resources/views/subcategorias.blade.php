...
@section('content')
    ...
    <div class="flex flex-wrap justify-evenly mt-4 gap-4">
        ...
        @foreach($subcategorias as $subcategoria)
            ...
            <a href="{{ route('productos.index', ['idSubcategoria' => $subcategoria->id_subcategoria ]) }}" class="bg-gray-200 hover:bg-gray-300 w-[300px] h-[200px] p-4 rounded cursor-pointer">
